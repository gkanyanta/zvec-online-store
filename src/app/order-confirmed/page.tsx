  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl px-6 py-3 inline-block mb-8">
          <p className="text-sm text-green-600 font-medium">Order Reference</p>
          <p className="text-2xl font-black text-green-800">{orderId}</p>
        </div>
          ...
          <ol className="space-y-3">
            {[
              ...
              <li key={item.step} className="flex items-start gap-3">
                <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold shrink-0 ${item.done ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-500'}`}>
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium py-3 rounded-xl transition-colors text-sm"
          >
            <MessageCircle size={16} /> WhatsApp Us
          </a>
          <a
            href="tel:+260970000000"
            className="flex items-center justify-center gap-2 border-2 border-green-600 text-green-700 font-medium py-3 rounded-xl hover:bg-green-50 transition-colors text-sm"
          >
