...
export default function PackagesPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#152a5c] to-[#1e3a8a] text-white py-14">
            ...
            <div key={pkg.id} id={pkg.id} className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
              ...
              <div className="p-8">
                  ...
                  {pkgProducts.map((product) => (
                    <div key={product.id} className="flex items-start gap-3 bg-gray-50 rounded-xl p-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-teal-700 font-bold text-sm mt-1">{formatPrice(product.price)}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="bg-teal-50 rounded-xl p-4 mb-8">
                  <h4 className="font-semibold text-teal-800 mb-3">Package Includes</h4>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-teal-500 hover:bg-teal-600 text-white font-bold px-8 py-3 rounded-xl transition-colors"
                  >
                  ...
                  <Link
                    href="/checkout"
                    onClick={() => addPackageToCart(pkg.products)}
                    className="flex items-center justify-center gap-2 border-2 border-teal-500 text-teal-700 font-bold px-8 py-3 rounded-xl hover:bg-teal-50 transition-colors"
                  >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-gradient-to-r from-teal-500 to-[#1e3a8a] rounded-2xl p-8 text-center text-white">
